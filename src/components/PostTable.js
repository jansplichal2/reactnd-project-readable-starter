                            ...
                            return(
                                <tr key={post.id}>
                                    ...
                                    <td className="controls_column">
                                        <i className="fa fa-thumbs-up" aria-hidden="true" title="Vote up"></i>
                                        <i className="fa fa-thumbs-down" aria-hidden="true" title="Vote down"></i>
                                        <br/>
                                        <i className="fa fa-edit" aria-hidden="true" title="Edit"></i>
                                        <i className="fa fa-trash" aria-hidden="true" title="Remove"></i>
                                    </td>
                                </tr>
                            );
                        })}
